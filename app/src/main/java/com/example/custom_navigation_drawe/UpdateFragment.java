...
public class UpdateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // for adapter to fragment data pass
        // get data
        expenseData = getArguments().getParcelable("DATA");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // for adapter to fragment data pass
        // get data
        textView_Select_Time.setText(expenseData.getTime());
        textView_Select_Date.setText(expenseData.getDate());
        editText_ammount.setText(String.valueOf(expenseData.getAmmount()));
        editText_expense.setText(expenseData.getText());
        //
        ...
        button_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (timeText.equals("")) {
                    ...
                    // Whene Emty field
                    Toast.makeText(getActivity(), "required Expenses", Toast.LENGTH_SHORT).show();
                    ...
                    expenseDatabase.expenseDao().update(sID, timeText, dateText, expenseText, ammountText);
                  ...
                  getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout,new Expense_list_Fragment()).commit();
